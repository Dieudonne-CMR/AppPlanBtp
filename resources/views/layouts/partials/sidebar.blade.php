    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            {{-- <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ url('/salles') }}"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Voir les salles </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('/add-salle') }}"><i
                                class="ri-circle-fill circle-icon text-info-main w-auto"></i>Add salle</a>
                    </li>
                </ul>
            </li> --}}
            ...
            <li class="dropdown dropdown-open">
                ...
                <ul class="sidebar-submenu" style="display: block;">
                    <li>
                        <a href="{{route('admin.createEntreprise')}}"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Create Entreprise</a>
                    </li>
                    <li>
                        <a href="{{route('admin.ListeEntreprise')}}"><i
                                class="ri-circle-fill circle-icon text-warning-main w-auto"></i>Liste Entreprise</a>
                    </li>
                </ul>
            </li>
        ...
        <li class="dropdown">
          ...
          <ul class="sidebar-submenu">
            ...
            <li>
              <a href="progress.html"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Progress
                bar</a>
            </li>
            <li>
        ...
        <li class="dropdown">
          ...
          <ul class="sidebar-submenu">
            ...
            <li>
              <a href="gallery-hover.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Gallery
                Hover Effect</a>
            </li>
          </ul>
        </li>
